...
public class problem1 {
	...
	public static void main(String[] args) {
		...
		// 가장 위에 노란색을 쌓는다면 나머지를 쌓는건 N-1개를 쌓는것과 같음
		// 가장 위에 파란색을 쌓는다면 그 밑에는 무조건 노란색이 있어야하므로 나머지를 쌓는건 N-2개를 쌓는 것과 같음
		// 그러므로 점화식은 An = An-1 + An-2
		
		System.out.println(dp[N]); // f(8) = 55
	}
